...
UPDATE locales_page_text SET
Text_loc3='Schläge: $B Schlag ins Gesicht: 2 Gold$B  Schlag in die Leistengegend: 3 Gold$B  Schlag auf die Brust: 1 Gold, 45 Silber$B  \n<Die detaillierte Preisliste für Sünden geht noch mehrere Seiten weiter.>'
WHERE entry=3118;
...
UPDATE locales_page_text SET
Text_loc3='Hochgeneral,$BDie Armeen von Herdweiler und Tirisfal sind weniger als einen Tag von Neu-Avalon entfernt. Wir reiten mit dem Lichte im Rücken, geschwind wie der Wind. Bald schon wird sich die Geißel der geballten Macht des Scharlachroten Kreuzzugs stellen müssen!$BDas Licht segne Euch,$BHochkommandant Galvar Reinblut'
WHERE entry=3120;
