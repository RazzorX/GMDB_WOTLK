...
UPDATE locales_points_of_interest SET icon_name_loc3='Alchemie von Darnassus' WHERE entry=102;
UPDATE locales_points_of_interest SET icon_name_loc3='Kochkunst von Darnassus' WHERE entry=103;
UPDATE locales_points_of_interest SET icon_name_loc3='Verzauberkunst von Darnassus' WHERE entry=104;
UPDATE locales_points_of_interest SET icon_name_loc3='Lehrer für Erste Hilfe von Darnassus' WHERE entry=105;
UPDATE locales_points_of_interest SET icon_name_loc3='Angler von Darnassus' WHERE entry=106;
UPDATE locales_points_of_interest SET icon_name_loc3='Inschriften von Darnassus' WHERE entry=107;
UPDATE locales_points_of_interest SET icon_name_loc3='Lederverarbeitung von Darnassus' WHERE entry=108;
UPDATE locales_points_of_interest SET icon_name_loc3='Kürschnerei von Darnassus' WHERE entry=109;
UPDATE locales_points_of_interest SET icon_name_loc3='Schneiderei von Darnassus' WHERE entry=110;
...
UPDATE locales_points_of_interest SET icon_name_loc3='Kräuterkunde von Darnassus' WHERE entry=440;
